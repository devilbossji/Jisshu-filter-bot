...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'mrperfectjikabot') # without @ or https://t.me/ 
USERNAME = environ.get('USERNAME', "mrperfectjikabot") # ADMIN USERNAME

# Database Channel 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002661852773').split()]
...
FILES_DATABASE = environ.get('FILES_DATABASE', "mongodb+srv://yashdd:yashdd@cluster0.1kn6zcl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'jisshu')

# Other Channel's
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002749179475'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002839994285'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002661852773') 
...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+sAIZx9peDdMyZjU9')
